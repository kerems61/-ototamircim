...
// Instagram logosu — lucide v1'de yok, inline SVG
...
const CONTACT_INSTAGRAM = "ototamircimonline";
// ──────────────────────────────────────────────
const LS = {
...
const CSS = `
  ...
  *{-webkit-overflow-scrolling:touch;}
  ...
  /* ── SOSYAL FAB STACK (WhatsApp + Instagram sağ kenarda) ── */
  .social-fabs{position:fixed;right:0;top:50%;transform:translateY(-50%);z-index:700;display:flex;flex-direction:column;gap:.375rem;}
  .social-fab{background:linear-gradient(135deg,#25d366,#1ebe57);color:#fff;border:none;cursor:pointer;padding:.875rem .625rem;border-radius:var(--r12) 0 0 var(--r12);writing-mode:vertical-rl;text-orientation:mixed;font-family:'Outfit',sans-serif;font-weight:700;font-size:.8125rem;letter-spacing:.04em;display:flex;align-items:center;gap:.4rem;box-shadow:-6px 6px 24px rgba(37,211,102,.35);transition:all .2s;text-decoration:none;}
  .social-fab:hover{padding-right:.875rem;box-shadow:-8px 8px 30px rgba(37,211,102,.5);}
  .social-fab svg{transform:rotate(90deg);}
  .social-fab.ig{background:linear-gradient(135deg,#feda75 0%,#fa7e1e 25%,#d62976 55%,#962fbf 80%,#4f5bd5 100%);box-shadow:-6px 6px 24px rgba(214,41,118,.35);}
  .social-fab.ig:hover{box-shadow:-8px 8px 30px rgba(214,41,118,.55);}
  @media(max-width:639px){
    .social-fabs{top:auto;bottom:calc(var(--mob-nav) + 5rem);transform:none;}
    .social-fab{padding:.625rem .4375rem;font-size:.6875rem;}
  }
      ...
      <footer className="footer">
        <div className="footer-grid">
          ...
          <div className="footer-col">
            ...
            <a href={`https://instagram.com/${CONTACT_INSTAGRAM}`} target="_blank" rel="noopener noreferrer" className="footer-link footer-link-btn" style={{ textDecoration: "none" }}><InstagramIcon size={14}/>@{CONTACT_INSTAGRAM}</a>
